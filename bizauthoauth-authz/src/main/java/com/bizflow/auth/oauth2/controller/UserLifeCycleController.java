...
import com.bizflow.auth.oauth2.model.Attribute;
import com.bizflow.auth.oauth2.model.LifeCycleResult;
...
public class UserLifeCycleController {
  ...
  private void addUserAttributes(Set<Attribute> attributes, OAuth2Authentication oAuth2Authentication) {
    OzUser user = OzUser.class.cast(oAuth2Authentication.getPrincipal());
