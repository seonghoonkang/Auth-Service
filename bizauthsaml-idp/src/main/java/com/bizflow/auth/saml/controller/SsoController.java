...
import com.bizflow.auth.saml.SAMLAttribute;
...
public class SsoController {
  ...
  @GetMapping("/logout")
  public void singleLogoutServiceGet(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws Exception
  {
    doLogout(request, response, authentication, false);
  }

  @PostMapping("/logout")
  public void singleLogoutServicePost(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws Exception
  {
  ...
  private void doLogout(HttpServletRequest request, HttpServletResponse response, Authentication authentication, boolean postRequest) throws SecurityException, MessageDecodingException, MetadataProviderException, ValidationException {
    SAMLMessageContext context = samlMessageHandler.extractSAMLMessageContext(request,response, postRequest);
  }
