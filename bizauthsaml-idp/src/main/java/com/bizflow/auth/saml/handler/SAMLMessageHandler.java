...
import static com.bizflow.auth.saml.SAMLBuilder.*;
...
public class SAMLMessageHandler {
    ...
    public SAMLMessageHandler(KeyManager keyManager, Collection<SAMLMessageDecoder> decoders,
                              ...
                              IdpConfiguration idpConfiguration, String idpBaseUrl, String contextPath) throws URISyntaxException {
        ...
        this.proxiedSAMLContextProviderLB = new ProxiedSAMLContextProviderLB(new URI(idpBaseUrl), contextPath);
        this.proxiedSAMLContextProviderLB.setContextPath(contextPath);
    }
...
//  Principal: 보호된 리소스에 접근하는 접근주체로 Spring Security 에서 사용하는 용어임
