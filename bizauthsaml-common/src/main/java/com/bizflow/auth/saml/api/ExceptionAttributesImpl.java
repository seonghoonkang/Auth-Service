...
public class ExceptionAttributesImpl implements ExceptionAttributes, HandlerExceptionResolver, Ordered {
    private static final String ERROR_ATTRIBUTE = ExceptionAttributesImpl.class.getName() + ".ERROR";

    private final boolean includeException;

    public ExceptionAttributesImpl() {
        this(false);
    }

    public ExceptionAttributesImpl(boolean includeException) {
